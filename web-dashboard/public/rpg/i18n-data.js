...
'notification.profilePendingReview': '您的贊助資訊已提交，管理員將在 24 小時內審核並為您開通權限。',
                    ...
                    'form.customAction.label': '開啟自訂動作功能 (詳見會員福利)', 'form.customAction.inputLabel': '你的自訂動作：', 'form.customAction.placeholder': '輸入你想執行的任何動作...',
...
'notification.profileUpdateError': 'Failed to save data. Please try again later.',
                    ...
                    'form.customAction.label': 'Enable Custom Actions (Details in Benefits)', 'form.customAction.inputLabel': 'Your Custom Action:',
...
'notification.questNew': '新クエスト:', 'notification.questComplete': 'クエスト完了:',
    ...
    'form.customAction.label': 'カスタムアクションを有効にする（詳細は特典にて）',
